...
public class WorldConstants {
    ...
    public static enum WorldOption {
    	Reboot(45, 10, 2, 2, (byte) 0, false, false, 20),
        ...
        Renegades(16, 1, 1, 1, (byte) 2, false, false, 20, "New World!"),
        ...
        public static final String recommendedmsg = "Try " + getById(recommended).name() + "! (If you have friends who play, consider joining their world instead.)";
